...
//    set_config($conf, false, 'notificationtype_enrollment');
    if(get_config('notificationtype_coursereminder', $conf) === false) {
        $value = $conf . '_default';
        set_config($conf, get_string($value, 'notificationtype_coursereminder'), 'notificationtype_coursereminder');
    }
}

$settings->add(new admin_setting_configtext(
    'notificationtype_coursereminder/teacher_subject',
...
$settings->add(new admin_setting_configtextarea(
    'notificationtype_coursereminder/teacher_content',
...
$settings->add(new admin_setting_configtext(
    'notificationtype_coursereminder/student_subject',
...
$settings->add(new admin_setting_configtextarea(
    'notificationtype_coursereminder/student_content',
