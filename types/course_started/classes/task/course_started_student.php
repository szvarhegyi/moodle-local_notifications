...
class course_started_student extends \core\task\scheduled_task
{

    public function get_name()
    {
        return get_string('messageprovider:student', 'notificationtype_course_started');
        ...
        if (count($courses) == 0) {
            ...
            foreach($courses as $course) {
                ...
                foreach ($users as $user) {
                    ...
                    $notify = new course_started_notification($course, $user, 'student');
                    $notify->notify();
                }
